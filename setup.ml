...
(* OASIS_START *)
(* DO NOT EDIT (digest: ac6dcec5734d367b4f9fdaa93d62a320) *)
(*
...
let setup_t =
  {
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_command = [(OASISExpr.EBool true, ("$main", []))];
                      test_custom =
                        {
                      ...
                      test_tools = [InternalExecutable "main"]
                   });
               Executable
                 ({
                     cs_name = "test_lib";
                   ...
                   {exec_custom = false; exec_main_is = "test_main.ml"});
               Test
                 ({
                     cs_name = "test_lib";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "test_lib"]
                   })
            ];
     ...
     oasis_digest = Some "L\240\131\161\180a\186lh\193\225N\170v^'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
