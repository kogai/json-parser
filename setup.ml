...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5aac88b4ce4f04aa6f9eb40adbbe039d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = ["stdfiles_markdown"];
          beta_features = [];
          name = "suburi-ocaml";
          license_file = None;
          copyrights = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "token"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some "@\215\201c\131g\131\224!9n:^Wo\241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
