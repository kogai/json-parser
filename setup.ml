...
(* OASIS_START *)
(* DO NOT EDIT (digest: b67776b0e29c0616d190efcdbf4a2391) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$suburi_ocaml_test", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "main.test.ml"});
               Test
                 ({
                     cs_name = "suburi_ocaml_test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "suburi_ocaml_test"]
                   })
            ];
     ...
     oasis_digest = Some "^p\244\241\148\219=\197X,\1755\231d|\028";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
