...
(* OASIS_START *)
(* DO NOT EDIT (digest: 235716f27b1b5afc285e03cbac266a19) *)
(*
...
let setup_t =
  {
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools = [ExternalTool "testing"]
                   })
            ];
     ...
     oasis_digest = Some "\202\243\248\232\229\166*P\140\199l.\019V='";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
